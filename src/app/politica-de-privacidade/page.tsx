  ...
  return (
    <main className="bg-[#f3f4f6]">
      ...
      <article className="mx-auto max-w-[1280px] px-5 py-16 lg:px-10 lg:py-20">
        ...
        <p>
          A Aceros Aços Centrifugados, inscrita no CNPJ nº 29.506.517/0001-39, com endereço comercial na Rua Hans Oersted, 20–118, Cidade Monções, São Paulo/SP, CEP 04575-010, atua como controladora dos dados pessoais tratados, nos termos da Lei Geral de Proteção de Dados (Lei nº 13.709/2018).
        </p>
