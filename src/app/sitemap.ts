...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: Array<{
    ...
    { path: '/rolos-de-forno', changeFrequency: 'monthly', priority: 0.9 },
    { path: '/sink-rolls', changeFrequency: 'monthly', priority: 0.9 },
    { path: '/fundicao-centrifugada', changeFrequency: 'monthly', priority: 0.9 },
