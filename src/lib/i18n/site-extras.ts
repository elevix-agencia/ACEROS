...
export const siteExtras: Record<Language, ExtraTranslations> = {
  pt: {
    ...
    hero: {
      ...
      stats: ['Aceros desde 2015', 'Aço inox centrifugado', 'Países atendidos', 'Sob medida'], contentLabel: 'Ir para o conteúdo',
    },
    ...
    footer: {
      ...
      quote: 'Solicitar orçamento', division: 'Fabricante brasileira de aços inoxidáveis centrifugados',
    },
    trust: {
      ...
      stats: [
        { number: '2015', label: 'Aceros desde', sub: 'Fabricante especializada em aços inoxidáveis centrifugados' },
  ...
  en: {
    ...
    hero: {
      ...
      stats: ['Aceros since 2015', 'Centrifugally cast stainless', 'Countries served', 'Custom-made'], contentLabel: 'Skip to content',
    },
    ...
    footer: {
      ...
      division: 'Brazilian centrifugally cast stainless steel manufacturer',
    },
    trust: {
      ...
      stats: [
        { number: '2015', label: 'Aceros since', sub: 'Brazilian centrifugally cast stainless steel manufacturer' },
  ...
  es: {
    ...
    hero: {
      ...
      stats: ['Aceros desde 2015', 'Acero inox centrifugado', 'Países atendidos', 'A medida'], contentLabel: 'Ir al contenido',
    },
    ...
    footer: {
      ...
      division: 'Fabricante brasileña de aceros inoxidables centrifugados',
    },
    trust: {
      ...
      stats: [
        { number: '2015', label: 'Aceros desde', sub: 'Fabricante especializada en aceros inoxidables centrifugados' },
  ...
  de: {
    ...
    hero: {
      ...
      stats: ['Aceros seit 2015', 'Edelstahl-Schleuderguss', 'Belieferte Länder', 'Maßgefertigt'], contentLabel: 'Zum Inhalt springen',
    },
    ...
    footer: {
      ...
      division: 'Brasilianischer Hersteller von schleudergegossenem Edelstahl',
    },
    trust: {
      ...
      stats: [
        { number: '2015', label: 'Aceros seit', sub: 'Brasilianischer Hersteller von schleudergegossenem Edelstahl' },
  ...
  it: {
    ...
    hero: {
      ...
      stats: ['Aceros dal 2015', 'Acciaio inox centrifugato', 'Paesi serviti', 'Su misura'], contentLabel: 'Vai al contenuto',
    },
    ...
    footer: {
      ...
      division: 'Produttore brasiliano di acciai inossidabili centrifugati',
    },
    trust: {
      ...
      stats: [
        { number: '2015', label: 'Aceros dal', sub: 'Produttore brasiliano di acciai inossidabili centrifugati' },
